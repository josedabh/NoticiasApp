...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">noticias-app documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/NoticiasCardsComponent.html" data-type="entity-link" >NoticiasCardsComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/NoticiasDetallesComponent.html" data-type="entity-link" >NoticiasDetallesComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/NoticiasListComponent.html" data-type="entity-link" >NoticiasListComponent</a>
                            </li>
                            <li class="link">
